    ...
    <div className="container px-2 mx-auto mt-20 mb-10">
      ...
      <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
        <div className="collapse collapse-arrow bg-orange-50">
          ...
          <div className="collapse-content">
            <p>
              ...
              purchase. The item must be in its original condition and
              packaging.
            </p>
          </div>
        </div>
        ...
        <div className="collapse collapse-arrow bg-orange-50">
          ...
          <div className="collapse-content">
            <p>
              Yes, we provide technical support for our products. You can reach
              our support team via phone or email.
            </p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-orange-50">
          ...
          <div className="collapse-content">
            <p>
              Yes, we take data security seriously. Our website uses encryption
        ...
        <div className="collapse collapse-arrow bg-orange-50">
          ...
          <div className="collapse-content">
            <p>
              Shipping costs and delivery times vary based on your location and
              the selected shipping method. You can find detailed information at
              checkout.
            </p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-orange-50">
          ...
          <div className="collapse-content">
            <p>
              Yes, we offer in-store pickup for select locations. You can choose
